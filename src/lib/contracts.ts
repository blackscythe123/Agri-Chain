// Minimal ABI for AgriTruthChain. Replace address after deploying via Remix/Foundry/Hardhat.
export const AGRI_TRUTH_CHAIN_ADDRESS = (import.meta as any).env?.VITE_AGRI_TRUTH_CHAIN_ADDRESS ?? "0xdB82ce16A44dda46E02e8b2F528fCD70808B9Cf9"; // set to deployed address or override via env
